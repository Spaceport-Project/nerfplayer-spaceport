...
nerfplayer_nerfacto_multicam = MethodSpecification(
    config=TrainerConfig(
        method_name="nerfplayer-nerfacto-multicam",
        steps_per_eval_batch=500,
        steps_per_save=2000,
        max_num_iterations=30000,
        mixed_precision=True,
...
nerfplayer_ngp_multicam = MethodSpecification(
    config=TrainerConfig(
        method_name="nerfplayer-ngp-multicam",
        steps_per_eval_batch=500,
        steps_per_save=2000,
        max_num_iterations=30000,
        mixed_precision=True,
